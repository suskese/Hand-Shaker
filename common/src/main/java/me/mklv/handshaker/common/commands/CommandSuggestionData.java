...
public final class CommandSuggestionData {
    ...
    public static final List<String> INFO_SUBCOMMANDS = List.of("configured_mods", "all_mods", "mod");
    public static final List<String> CONFIG_PARAMS = List.of("behavior", "integrity", "whitelist", "allow_bedrock", "playerdb_enabled");
    ...
    public static final List<String> DEFAULT_ACTIONS = List.of("kick", "ban");
